...
export class PapelPermissaoTelaController {
  constructor(private readonly papelPermissaoTelaService: PapelPermissaoTelaService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePapelPermissaoTelaDto: UpdatePapelPermissaoTelaDto) {
    return this.papelPermissaoTelaService.update(+id, updatePapelPermissaoTelaDto);
  }
